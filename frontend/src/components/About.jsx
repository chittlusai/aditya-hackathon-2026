    ...
    <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8 space-y-6">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 shadow-sm">
        ...
        <p className="mt-2 text-slate-600 text-sm leading-relaxed">
          <strong className="text-slate-900">Arogya Setu Local</strong> is a dedicated rural healthcare triage and facility referral portal designed for the <strong className="text-slate-900">Smart India Hackathon 2026</strong>. The portal provides instant clinical triage guidance for rural citizens and ASHA field workers to ensure patients reach the appropriate Primary Health Centre (PHC), Community Health Centre (CHC), or District Hospital without critical delays.
        </p>
      </div>
