...
function Shell() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-800 font-sans">
      ...
      {/* Main Content Router with Real URL Synchronization & Citizen Login */}
      ...
      {/* 2. Citizen Profile Modal */}
      <AuthModal />

      {/* 3. Doctor Profile & Credentials Desk */}
      <DoctorProfileModal />

      {/* 4. Real-Time Teleconsultation WhatsApp Video Call Room */}
      <TeleconsultVideoCallModal />

      {/* 5. Patient Health Assessment History Modal */}
      <PatientHistoryModal />
